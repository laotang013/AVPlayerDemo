 ...
 */
///询问代理是否需要对下载的图像进行transform操作，然后缓存transFrom之后的图片，如果代理实现了这个方法则需要返回一张图片
 ...
 */
///WebCache分类中的sd_setImageWithURL最终都会调用SDWebImageManager类中的
///根据URL下载图片 如果缓存中有则直接从缓存中拿
